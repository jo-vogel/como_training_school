...
###########                                                        ###########
###########                  Sensitivy analysis                    ###########
###########       (random seed and training data size)             ###########
###########                                                        ###########
...
# a) Load the data
# b) build training and testing dataset for config in CONFIG
...
# CONFIG = {(seed=1,  TRAIN=60%), (seed=2020, TRAIN=60%), (seed=1994, TRAIN=80%)}
# Note: what had been done by default: (seed=1994, TRAIN=60%)
...
save(model_cv_fitting, file = paste0("C:/Users/admin/Documents/Damocles_training_school_Como/GroupProject1/RidgeRegression/Global_results/SensitivityAnalysis/cv_month_xtrm_LASSO_threshbadyield005_seed",
                                     seed, "_train", train_size,".RData"))


##### Run the model with lambda1se and lambda min #####

load(file = paste0("C:/Users/admin/Documents/Damocles_training_school_Como/GroupProject1/RidgeRegression/Global_results/SensitivityAnalysis/cv_month_xtrm_LASSO_threshbadyield005_seed",
                   seed, "_train", train_size,".RData"))
...
if (model_name == "Lasso"){
  ...
  save(lasso_model_lambdamin, file = paste0("C:/Users/admin/Documents/Damocles_training_school_Como/GroupProject1/RidgeRegression/Global_results/SensitivityAnalysis/Lasso_lambdamin_month_xtrm_LASSO_threshbadyield005_seed",
                                            seed, "_train", train_size,".RData"))
  save(lasso_model_lambda1se, file = paste0("C:/Users/admin/Documents/Damocles_training_school_Como/GroupProject1/RidgeRegression/Global_results/SensitivityAnalysis/Lasso_lambda1se_month_xtrm_LASSO_threshbadyield005_seed",
                                            seed, "_train", train_size,".RData"))
}
toc()
# 2min for Lasso
...
segreg_th_adj_1se <- cutoff_simple_lasso
...
ggplot(data = DF_sci, aes(x=lon, y=lat)) +
  ...
  coord_fixed(xlim = c(-120, 135),
              ...
              ratio = 1.3)+
  labs(fill="CSI",
       title = paste("CSI, Lasso for seed ",seed,", training set size ", train_size,"%"),
...
pdf(file=paste0("C:/Users/admin/Documents/Damocles_training_school_Como/GroupProject1/RidgeRegression/Global_results/SensitivityAnalysis/barplot_variables_lambda1se_seed",
              seed, "_trainsetsize", train_size, ".pdf")
    #,
    #res=2000,units="cm"
    , width=6,height=8
    )
