...
data1 <- read.csv("C:/Users/vogelh/ownCloud/Promotion/Data/car.data", header = TRUE)
colnames(data1) <- c("buying","maint","doors","persons","lug_boot","safety","Condition") # for some reason, they are unnamed, so I have to name the columns
