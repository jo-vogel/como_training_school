...
# coefs_seas <- sapply(1:length(coeff), function(x) names(numLevels_list[[x]])[coeff[[x]][-1]!=0]) # wrong entries picked
...
# coefs_seas_afr <- sapply(loc_afr_pixels_num, function(x) names(numLevels_list[[x]])[coeff[[x]][-1]!=0]) # wrong entries picked
...
# coefs_seas_eur <- sapply(loc_eur_pixels_num, function(x) names(numLevels_list[[x]])[coeff[[x]][-1]!=0]) # wrong entries picked
...
# coefs_seas_no_am <- sapply(loc_no_am_pixels_num, function(x) names(numLevels_list[[x]])[coeff[[x]][-1]!=0]) # wrong entries picked
...
# coefs_seas_asia <- sapply(loc_asia_pixels_num, function(x) names(numLevels_list[[x]])[coeff[[x]][-1]!=0]) # wrong entries picked
