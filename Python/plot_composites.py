...
data_dir = '/Users/christoph/Desktop/DAMOCLES_training_school/WorkingGroup1/' \
           'nc_data/'
...
lab_fontsize = 22
ax_fontsize = 18
var_lost_plot = ['dps', 'pr_rsum', 'rsds', 'sfcwind', 'tasmax', 'tasmin', 'vpd']
...
for country in gp:
    ...
    var_counter = 0
    data_extr[country]['pr_rsum_neg'] = running_sum(data_extr[country]['pr_neg'],
                                                    running_days=30)
    data_extr[country]['pr_rsum_av'] = running_sum(data_extr[country]['pr_av'],
                                                   running_days=30)
        ...
        for ax_h in range(2):
            if var_counter == 0:
                ...
                plot_mean_with_percentiles(data_extr[country][var +
                                                              '_neg'][:, 304:304+320], alpha=alpha,
                                   plot_color=orange, percentile_value=10)
                plot_mean_with_percentiles(data_extr[country][var + '_av'][:, 304:304+320], alpha=alpha,
                                   plot_color=blue, percentile_value=10)
